...
function renderResults(results) {
  ...
  resultDiv.innerHTML = ""; // återställ sökresultatet
  ...
  for (let index = 0; index < allObjects.length; index++) {
    ...
    resultDiv.innerHTML += `<p>${allObjects[index].original_title}</p>`;
    resultDiv.innerHTML += `<img src="https://image.tmdb.org/t/p/original${allObjects[index].poster_path}" width="10%"></img>`;
  }
}
